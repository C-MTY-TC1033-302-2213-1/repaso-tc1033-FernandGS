...
void Triangulo::setVertices1(Punto _v1){
    v1 = _v1;
}
void Triangulo::setVertices2(Punto _v2){
    v2 = _v2;
}
void Triangulo::setVertices3(Punto _v3){
    v3 = _v3;
}
...
double Triangulo::perimetro(){
    return v2.calculaDistancia(v1) + v3.calculaDistancia(v2) +
